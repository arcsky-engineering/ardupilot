...
class AP_BattMonitor_Generic_Fuel : public AP_BattMonitor_Backend
{
public:

    /// Constructor
    AP_BattMonitor_Generic_Fuel(AP_BattMonitor &mon, AP_BattMonitor::BattMonitor_State &mon_state, AP_BattMonitor_Params &params);

    /// Read the battery voltage and current.  Should be called at 10hz
    virtual void read() override;

    //void setGenFound(void) const override;
