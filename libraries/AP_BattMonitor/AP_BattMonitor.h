...
public:
    ...
    struct BattMonitor_State {
        ...
        uint32_t    low_soc_start_ms;          // time when state of charge dropped below the low threshold in milliseconds
        uint32_t    critical_soc_start_ms;     // time when state of charge dropped below the critical threshold in milliseconds
